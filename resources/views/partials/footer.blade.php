<div class="section bg-light mt-4" id="footer">
    <div class="container">
        <div class="row">
            ...
            <!-- // end .col-sm-3 -->
            <div class="col-sm-2">
                <a href="#home" class="btn btn-sm btn-outline-primary ml-1">Vers Le Haut</a>
            </div>
            <!-- // end .col-sm-3 -->
        </div>
        <!-- // end .row -->
        <div class=" text-center mt-4"> <small class="text-muted">Copyright ©
                ...
                All rights reserved.Designed by <a href="http://www.segoor.net" target="_blank"
                    rel="noopener noreferrer">Segoor</a>
            </small></div>
    </div>
    <!-- // end .container -->
</div>
